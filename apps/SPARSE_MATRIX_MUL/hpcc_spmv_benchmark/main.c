...
int main(int argc, char **argv) {
  ...
  bench_params.n_row_blockdims = 1;
  //bench_params.n_col_blockdims = 6;
  bench_params.n_col_blockdims = 1;
  //bench_params.nnz_per_row_min = 24;
  bench_params.nnz_per_row_min = nnz;
  //bench_params.nnz_per_row_max = 34;
  bench_params.nnz_per_row_max = nnz;
  //bench_params.mindim = 512;
  bench_params.mindim = 131072;
