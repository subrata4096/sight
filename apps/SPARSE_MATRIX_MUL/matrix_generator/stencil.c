				...
				double **pval)
{
  ...
  rowptr = (int*)smvm_malloc ((N_cubed + 1) * sizeof (int));
  /* We overestimate nnz here; we will later revise the overestimate and scale
   * down the vectors. */
  colidx = (int*)smvm_malloc (27 * N_cubed * sizeof (int));
  values = (double*)smvm_malloc (block_size * 27 * m * sizeof (double));
  ...
  if (N == 1)
	...
	values[j] = smvm_random_double(-1,1);
      ...
      colidx = (int*)smvm_realloc (colidx, 1 * sizeof (int));
      values = (double*)smvm_realloc (values, block_size * sizeof (double));
      ...
      for (i = 0; i < N_cubed; i++)
	{
      ...
      WITH_DEBUG(fprintf(stderr, "Reallocating colidx and values arrays..."));
      colidx = (int*)smvm_realloc (colidx, k * sizeof (int));
      values = (double*)smvm_realloc (values, k * block_size * sizeof (double));
      WITH_DEBUG(fprintf(stderr, "done."));
  ...
  WITH_DEBUG(fprintf(stderr, "Reallocating colidx and values arrays..."));
  colidx = (int*)smvm_realloc (colidx, k * sizeof (int));
  values = (double*)smvm_realloc (values, block_size * k * sizeof (double));
  WITH_DEBUG(fprintf(stderr, "done.\n"));
			       ...
			       double **pval)
{
  ...
  rowptr = (int*)smvm_malloc ((r*n + 1) * sizeof (int));
  colidx = (int*)smvm_malloc (nnzb * sizeof (int));
  values = (double*)smvm_malloc (nnz * sizeof (double));
			  ...
			  const int end_row)
{
  ...
  II = (int*)smvm_calloc (nnz, sizeof (int));
  JJ = (int*)smvm_calloc (nnz, sizeof (int));
  val = (double*)smvm_calloc (nnz, sizeof (double));
  ...
  if (n == 1)
    {
      ...
      add_elt( 16.0, 0, 0 );
      II = (int*)smvm_realloc (II, k * sizeof (int));
      JJ = (int*)smvm_realloc (JJ, k * sizeof (int));
      val = (double*)smvm_realloc (val, k * sizeof (double));
			       ...
			       double **pval)
{
  ...
  rowptr = (int*)smvm_malloc ((n*n+1) * sizeof (int));
  colidx = (int*)smvm_malloc (nnzb * sizeof (int));
  values = (double*)smvm_malloc (nnz * sizeof (double));
...
stencil_9pt_random_csr_matrix (const int n)
{
  ...
  if (errcode != 0)
    return NULL;
  return create_bcsr_matrix (n*n, n*n, 1, 1, nnz, val, idx, ptr, UNSYMMETRIC, (symmetric_storage_location_t)0, REAL, 0);
}
...
stencil_27pt_random_bcsr_matrix (const int N, const int r, const int c)
{
  ...
  return create_bcsr_matrix (N_cubed, N_cubed, r, c, nnzb, val, idx, ptr, UNSYMMETRIC, (symmetric_storage_location_t)0, REAL, 0);
}
...
stencil_3pt_random_bcsr_matrix (const int n, const int r, const int c)
{
  ...
  return create_bcsr_matrix (n, n, r, c, nnzb, val, idx, ptr, UNSYMMETRIC, (symmetric_storage_location_t)0, REAL, 0);
}
...
stencil_9pt_random_bcsr_matrix (const int n, const int r, const int c)
{
  ...
  return create_bcsr_matrix (n_squared, n_squared, r, c, nnzb, val, idx, ptr, UNSYMMETRIC, (symmetric_storage_location_t)0, REAL, 0);
}
...
stencil_3pt_coo_matrix (const int n, const int start_row, const int end_row)
{
  ...
  return create_coo_matrix (end_row - start_row + 1, n, nnz, II, JJ, val, 
			    ZERO, UNSYMMETRIC, (symmetric_storage_location_t)0, REAL);
}
					 ...
					 const int end_block_row)
{
  ...
  rowptr = (int*)smvm_malloc ((end_block_row - start_block_row + 2) * sizeof (int));
  /* We overestimate nnz here; we will later revise the overestimate and scale
   * down the vectors. */
  colidx = (int*)smvm_malloc (27 * n_cubed * sizeof (int));
					...
					const int end_block_row)
{
  ...
  if (n == 1)
    {
      rowptr = (int*)smvm_malloc (2 * sizeof (int));
      colidx = (int*)smvm_malloc (1 * sizeof (int));
